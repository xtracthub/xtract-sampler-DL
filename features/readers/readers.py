...
if __name__ == "main":
    head_bytes_feature_maker = HeadBytes(size=1024)
    directory_reader = NaiveTruthReader(head_bytes_feature_maker, "cdiac_naivetruth_processed.csv")
    directory_reader.run()
